...
async function fetchIntraday(symbol,interval,range){
  // Intraday prediction itself is generated by the original Kronos model in the scheduled
  // GitHub pipeline; this function intentionally fetches only the freshest market candles.
